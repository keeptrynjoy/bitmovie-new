    ...
    return (
        <div className={"footer-big"}>
            <div className={"footer-div"}>
                <img className={"logoimg"} alt={"로고"} src={logo} style={{ marginTop:'1.2%',  marginRight:'1%', marginBottom:'10px', width:'7A%', marginLeft:'10%' }}/>
                <p style={{paddingTop:'40px', marginLeft:'25%', fontSize:'15px', position:'absolute'}}>
