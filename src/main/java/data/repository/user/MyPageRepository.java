...
public interface MyPageRepository {
    ...
    public MyPage selectBooking (String user_pk); //마이페이지 예매 목록 조회
    public MyPage selectMovieLog (String user_pk); //마이페이지 무비로그 조회
    public int selectPoint (String user_pk); //마이페이지 포인트 조회
    public MyPage selectPointDetail (String user_pk); //마이페이지 포인트 적립/소멸 조회
}
